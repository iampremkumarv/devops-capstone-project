...
![Build Status](https://github.com/iampremkumarv/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
This is my submission for the **IBM DevOps Capstone Project**, part of the IBM DevOps and Software Engineering Professional Certificate. This microservice manages customer **Accounts** for an e-commerce platform, providing a RESTful API to Create, Read, Update, Delete, and List accounts. The project follows Test-Driven Development (TDD) practices with 95%+ code coverage, is containerized with Docker, deployed to Kubernetes/OpenShift, and built with an automated CI/CD pipeline using Tekton.
